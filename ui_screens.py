...
def draw_mechanics_guide_modal(surface, mouse_pos, current_tab=0, context="combat"):
    ...
    if context == "tree":
        if current_tab == 0:
            draw_guide_card(
                ...
                (255, 140, 40),
                [
                    ("• Урон: ", "+4% к общему урону за уровень таланта (до +20% на 5 ур.).", (240, 245, 255)),
                    ("• Крит: ", "+3% шанс и +25% к урону крита за уровень (до 15% шанса и 225% урона).", (255, 215, 80)),
                    ("• Скорость: ", "+3% к скорости атаки всех башен за уровень (до +15% на 5 ур.).", (140, 245, 170))
                ],
                badge_text="БОЙ",
            ...
            draw_guide_card(
                ...
                (255, 210, 60),
                [
                    ("• Доход с мобов: ", "+10% кактусов за ликвидацию слаймов за уровень (до +50%).", (240, 245, 255)),
                    ("• Стартовый капитал: ", "+75 кактусов на старте каждого боя за уровень (до +375).", (140, 255, 180)),
                    ("• Ферма [6]: ", "Открывает постройку ферм, плодородную почву и полив соседних башен.", (255, 220, 120))
                ],
                badge_text="ЗОЛОТО",
            ...
            draw_guide_card(
                ...
                (80, 210, 255),
                [
                    ("• Лимит уровней: ", "Повышает максимальный уровень башен в бою с 20 до 30 (+2 за ранг).", (240, 245, 255)),
                    ("• Стартовый уровень: ", "Башни строятся сразу 1–3 уровня без доп. затрат в бою.", (140, 245, 170)),
                    ("• Автосбор и [МАКС]: ", "Магнит монет и кнопка улучшения башни на все деньги в один клик.", (255, 215, 90))
                ],
                badge_text="БАШНИ",
            ...
            draw_guide_card(
                "МЕТЕОРИТЫ И ТЁМНЫЕ КАКТУСЫ",
                (195, 120, 255),
                [
                    ("• Астральный Маяк: ", "Узел за 25 Звёзд открывает Метеориты и добычу Тёмных кактусов.", (255, 215, 80)),
                    ("• Падение: ", "Метеорит падает каждые 15–20 волн. Содержит 1–2 Тёмных кактуса.", (220, 160, 255)),
                    ("• Квантовый Жатватель: ", "+1 Тёмный кактус за уничтожение метеорита за ранг (до +3).", (140, 245, 170))
                ],
                badge_text="РЕСУРС",
                icons=[dark_cactus_img, meteorite_img]
            )
            draw_guide_card(
                "ТЁМНЫЙ ЭГИС И ВОРОНКА",
                (120, 220, 255),
                [
                    ("• Тёмный Эгис: ", "Блокирует 1 (на 1 ур.) или 2 (на 2 ур.) прорыва врагов за волну без урона базе.", (120, 240, 255)),
                    ("• Тёмный Резонанс: ", "+5%..+20% силы ВСЕМ реликвиям музея пассивно без пьедесталов.", (225, 160, 255)),
                    ("• Горизонт Событий: ", "+50% радиус и +100% урон воронки Орбитального Залпа [F].", (255, 180, 140))
                ],
                badge_text="ЗАЩИТА",
                icons=[crown_upg_icon, dark_cactus_img]
            )
            draw_guide_card(
                "КОРОНА ОАЗИСА (КАП 35 УР.)",
                (255, 215, 75),
                [
                    ("• Сверхпрокачка: ", "Позволяет качать башни выше 30 уровня — вплоть до 35 уровня.", (255, 220, 100)),
                    ("• Стоимость: ", "Требует Тёмные кактусы (3, 5, 8, 12, 18) и открытый Горизонт Событий.", (235, 175, 255)),
                    ("• Эффект: ", "Башни 35 ур. наносят огромный урон для прохождения поздних волн.", (140, 255, 180))
                ],
                badge_text="МАКС. СИЛА",
            ...
            draw_guide_card(
                ...
                (255, 205, 80),
                [
                    ("• Звёздные кактусы: ", "8% шанс с обычных мобов, 25% гарантированно с боссов (каждые 5 волн).", (255, 235, 140)),
                    ("• Тёмные кактусы: ", "Добываются с метеоритов (1–4 шт.) и боссов супер-волн 2000+.", (220, 140, 255)),
                    ("• Раскопки: ", "Приносят фрагменты реликвий. Замакшенные реликвии дают чистые звёзды.", (140, 245, 170))
                ],
                badge_text="ВАЛЮТА",
            ...
            draw_guide_card(
                ...
                (100, 230, 255),
                [
                    ("• Рубежи волн: ", "Прохождение 10, 25, 50, 75, 100 волн даёт пачки звёздных кактусов.", (240, 245, 255)),
                    ("• Старт с волны: ", "Пройденные рубежи открывают быстрый старт с 6, 11, 26 или 101 волны.", (140, 255, 180)),
                    ("• Награда старта: ", "При быстром старте сразу начисляются кактусы за пропущенные волны.", (255, 215, 90))
                ],
                badge_text="ПРОПУСК ВОЛН",
                icons=[start_lvl_icon, trophy_icon]
            )
            draw_guide_card(
                "БЕСПЛАТНЫЙ СБРОС ДРЕВА",
                (80, 240, 150),
                [
                    ("• Кнопка сброса: ", "Доступна в меню Настроек игры в любой момент.", (240, 245, 255)),
                    ("• Без потерь: ", "100% потраченных Звёздных и Тёмных кактусов возвращаются на баланс.", (120, 255, 160)),
                    ("• Билды: ", "Можно свободно перераспределять очки под разные карты без штрафов.", (255, 220, 110))
                ],
    ...
    # -------------------------------------------------------------
        ...
        if current_tab == 0:
            draw_guide_card(
                "САГУАРО, ОПУНЦИЯ И МАМИЛЛЯРИЯ",
                (80, 225, 130),
                [
                    ("• Сагуаро: ", "+2..+15 HP базе, +15%..+60% урона шипов, 5%..10% шанс блока урона.", (240, 245, 255)),
                    ("• Опунция: ", "+40..+220 кактусов на старте боя, +5%..+20% семян, +10%..+20% фермам.", (255, 220, 100)),
                    ("• Мамиллярия: ", "Воскрешение воинов на 15%..55% быстрее, +20%..+80% HP, щит и шипы.", (140, 255, 180))
                ],
                badge_text="БАЗА И ВОИНЫ",
                icons=[gh_tex.get("gh_saguaro", cactus_img), gh_tex.get("gh_opuntia", cactus_img)]
            )
            draw_guide_card(
                "ОГНЕННЫЙ БОЧОНОК И ЛЕДЯНОЙ АЛОЭ",
                (255, 140, 80),
                [
                    ("• Огненный Бочонок: ", "+5%..+30% урона огня, горение +1..+2.5 сек., уязвимость цели +10%..+15%.", (255, 140, 100)),
                    ("• Ледяной Алоэ: ", "+7%..+30% замедление, +10%..+25% радиус, срезает 15%..25% брони врагов.", (100, 220, 255)),
                    ("• Термошок: ", "Совместная прокачка огня и льда усиливает комбо-урон в бою.", (255, 215, 80))
                ],
                badge_text="ОГОНЬ И ЛЁД",
                icons=[gh_tex.get("gh_fire_barrel", cactus_img), gh_tex.get("gh_frost_aloe", cactus_img)]
            )
            draw_guide_card(
                "ЭХИНО, БЕЗДНА И ЦАРИЦА НОЧИ",
                (195, 130, 255),
                [
                    ("• Громовой Эхино: ", "+1..+2 рикошета цепной молнии Теслы, +8%..+28% урона, оглушение.", (255, 240, 120)),
                    ("• Астрофитум Бездны: ", "+10%..+45% урона по боссам и Теневым, срезает маг. защиту.", (210, 140, 255)),
                    ("• Звёздный Цереус: ", "+15%..+80% урона Дрона. На 5 ур. ДРОН АТАКУЕТ 2 ЦЕЛИ ОДНОВРЕМЕННО!", (130, 245, 170))
                ],
                badge_text="МОЛНИЯ И ДРОН",
            ...
            draw_guide_card(
                ...
                (255, 210, 60),
                [
                    ("• Рост по уровням: ", "Для ур. 1, 2, 3, 4, 5 нужно соответственно 1, 3, 8, 18, 35 саженцев.", (255, 220, 110)),
                    ("• Где брать саженцы: ", "Выпадают при завершении волн, с боссов и при сборе урожая в оранжерее.", (240, 245, 255)),
                    ("• Сорта: ", "Каждый сорт даёт постоянный пассивный бонус, действующий во всех боях.", (140, 255, 180))
                ],
                badge_text="САЖЕНЦЫ",
            ...
            draw_guide_card(
                ...
                (80, 210, 255),
                [
                    ("• Эффект полива: ", "Ускоряет рост кактусов ровно в 2 раза (+100% скорости).", (120, 245, 160)),
                    ("• Время действия: ", "Один полив увлажняет почву на 120 секунд.", (240, 245, 255)),
                    ("• Связь с фермой: ", "Кактусовая ферма в бою автоматически поставляет росу в оранжерею.", (255, 215, 90))
                ],
                badge_text="УСКОРЕНИЕ Х2",
            ...
            draw_guide_card(
                ...
                (140, 240, 160),
                [
                    ("• Созревание: ", "При заполнении шкалы на 100% клик по горшку собирает готовые саженцы.", (240, 245, 255)),
                    ("• Буфер накопления: ", "Кактусы могут хранить до 10 несобранных урожаев без потерь.", (140, 255, 180)),
                    ("• АФК-рост: ", "Оранжерея продолжает расти прямо во время прохождения волн в бою.", (255, 220, 100))
                ],
                badge_text="ХРАНИЛИЩЕ",
                icons=[sprout_icon]
            )
        else:
            draw_guide_card(
                ...
                (255, 195, 75),
                [
                    ("• Действие: ", "Увеличивает силу ВСЕХ бонусов Оранжереи на +10% за каждый уровень таланта.", (240, 245, 255)),
                    ("• Что усиливает: ", "HP базы, урон огня, замедление льда, скачки Теслы и урон Дрона.", (140, 255, 180)),
                    ("• Как работает: ", "Перемножается с базовыми показателями каждого выращенного кактуса.", (255, 215, 90))
                ],
                badge_text="+10%/УР.",
            ...
            draw_guide_card(
                ...
                (100, 230, 255),
                [
                    ("• Бонус урона: ", "+0.2% урона всем башням за каждый суммарный уровень кактусов в оранжерее.", (255, 220, 100)),
                    ("• Максимум: ", "При 8 кактусах 5 уровня (всего 40 ур.) даёт постоянные +8%..+40% урона.", (140, 255, 180)),
                    ("• Польза: ", "Каждый прокачанный горшок напрямую повышает силу башен на поле боя.", (240, 245, 255))
                ],
            ...
            draw_guide_card(
                ...
                (80, 240, 150),
                [
                    ("• Престиж: ", "Полная прокачка всех 8 сортов позволяет запустить Престиж с множителем x1.25.", (255, 215, 90)),
                    ("• Сохранение: ", "Все Звёздные и Тёмные кактусы при престиже сохраняются в полном объёме.", (120, 255, 160)),
                    ("• Итог: ", "Долгосрочное развитие оранжереи делает армию кактусов в разы сильнее.", (240, 245, 255))
                ],
    ...
    # -------------------------------------------------------------
        ...
        if current_tab == 0:
            draw_guide_card(
                "РЕЛИКВИИ РАННИХ КАРТ (0 - 2)",
                (255, 195, 75),
                [
                    ("• Оазис (Карта 0): ", "«Древний Кувшин» (+10%/ур. фермам) и «Окаменелая Игла» (+4%/ур. дальности).", (240, 245, 255)),
                    ("• Каньон (Карта 1): ", "«Песчаный Молот» (+8%/ур. огню) и «Фляга Первопроходца» (+2 HP базе/ур.).", (255, 215, 90)),
                    ("• Шахты (Карта 2): ", "«Магматический Сгусток» (+6%/ур. по льду) и «Шахтёрский Жетон» (-10%/ур. цена 1-й башни).", (140, 255, 180))
                ],
                badge_text="КАРТЫ 0–2",
                icons=[relic_icon, shovel_icon]
            )
            draw_guide_card(
                "РЕЛИКВИИ СРЕДНИХ И ПОЗДНИХ КАРТ (3 - 9)",
                (100, 220, 255),
                [
                    ("• Дюны (Карта 3): ", "«Солнечный Диск» (+10%/ур. дальности магии) и «Песочные Часы» (+15%/ур. заморозке).", (240, 245, 255)),
                    ("• Карты 4–7: ", "«Громовой Зуб» (+3 скачка Теслы), «Кольцо Воина» (+15% HP солдат), «Сердце Оазиса» (+5 HP).", (140, 255, 180)),
                    ("• Космос (Карты 8–9): ", "«Око Бездны» (+20% пробития брони) и «Астральный Компас» (+15% шанс звёзд).", (220, 160, 255))
                ],
                badge_text="КАРТЫ 3–9",
                icons=[relic_icon, tesla_tower_img]
            )
            draw_guide_card(
                "УРОВНИ И СИЛА РЕЛИКВИЙ",
                (255, 215, 75),
                [
                    ("• Базовый лимит: ", "По умолчанию реликвии качаются до 5 уровня.", (240, 245, 255)),
                    ("• Архивы Музея: ", "Талант в Древе расширяет максимальный уровень реликвий до 10, 15 и 20.", (255, 215, 90)),
                    ("• Линейный рост: ", "Бонус реликвии растёт строго пропорционально уровню (База × Уровень).", (140, 255, 180))
                ],
            ...
            draw_guide_card(
                ...
                (255, 210, 60),
                [
                    ("• Слоты: ", "Доступно 2 базовых пьедестала (до 5 слотов с талантами Древа).", (240, 245, 255)),
                    ("• Сила: ", "Реликвии на пьедестале передают 100% своего эффекта в бой.", (140, 255, 180)),
                    ("• Управление: ", "Клик по реликвии ставит её на свободный пьедестал, клик по пьедесталу снимает.", (255, 215, 90))
                ],
            ...
            draw_guide_card(
                ...
                (195, 120, 255),
                [
                    ("• Эффект: ", "Даёт +5%..+20% силы ВСЕМ 20 реликвиям музея одновременно!", (220, 160, 255)),
                    ("• Без пьедестала: ", "Реликвии работают в фоне, даже если они НЕ выставлены на пьедестал.", (140, 255, 180)),
                    ("• Сила коллекции: ", "Чем больше у вас открытых и прокачанных реликвий, тем сильнее вся база.", (255, 220, 100))
                ],
                badge_text="ПАССИВКА",
                icons=[dark_cactus_img, crown_upg_icon]
            )
            draw_guide_card(
                "СИНЕРГИЯ С ДРЕВОМ И ОРАНЖЕРЕЕЙ",
                (80, 220, 140),
                [
                    ("• Мультипликативность: ", "Бонусы реликвий перемножаются с бонусами Древа талантов и Оранжереи.", (240, 245, 255)),
                    ("• Фермы и урон: ", "Позволяет разгонять доход ферм и урон башен до огромных значений.", (140, 255, 180)),
                    ("• Коллекция: ", "Стенды музея показывают прогресс сбора всех 20 артефактов.", (170, 220, 255))
                ],
                badge_text="СИНЕРГИИ",
            ...
            draw_guide_card(
                ...
                (255, 195, 75),
                [
                    ("• Появление: ", "Курган раскопок появляется во время волны. Клавиша [R] сразу открывает раскопки.", (240, 245, 255)),
                    ("• Ходы: ", "Базово даётся 12 ходов (до 18+ с талантом «Археологическое чутьё»).", (255, 215, 90)),
                    ("• Поиск фигуры: ", "Реликвия скрыта в форме фигуры 1х2, 1х3 или 2х2. Клетки подсказывают расстояние.", (140, 255, 180))
                ],
                badge_text="СЕТКА 5х5",
                icons=[shovel_icon]
            )
            draw_guide_card(
                "ФРАГМЕНТЫ ДЛЯ ПРОКАЧКИ",
                (100, 230, 255),
                [
                    ("• Требования: ", "Для ур. 1, 2, 3, 4, 5 нужно 1, 2, 4, 8, 16 фрагментов соответственно.", (255, 215, 90)),
                    ("• Добыча: ", "Победа в раскопках даёт 1 фрагмент реликвии биома, опыт и Звёздные кактусы.", (140, 255, 180)),
                    ("• Скорость: ", "Быстрый сбор фигур позволяет прокачать артефакты до максимума за несколько раскопок.", (240, 245, 255))
                ],
                badge_text="1, 2, 4, 8, 16",
                icons=[relic_icon, crown_upg_icon]
            )
            draw_guide_card(
                "ЗАМАКШЕННЫЕ БИОМЫ И ЗВЁЗДЫ",
                (80, 240, 150),
                [
                    ("• Награда: ", "Когда обе реликвии карты прокачаны на максимум, раскопки на ней дают чистые Звёзды.", (255, 220, 100)),
                    ("• Время жизни: ", "Талант «Стойкий Раскоп» увеличивает время жизни кургана на +10 сек за ранг.", (240, 245, 255)),
                    ("• Горячая клавиша: ", "Нажатие [R] во время боя мгновенно переносит в активные раскопки.", (120, 245, 160))
                ],
                badge_text="ЗВЁЗДЫ",
    ...
    # -------------------------------------------------------------
        ...
        if current_tab == 0:
            draw_guide_card(
                ...
                (255, 140, 40),
                [
                    ("• Заморозка: ", "Ледяная башня замедляет врагов на 36%..80% на 2.4–4.2 сек.", (240, 245, 255)),
                    ("• Термоудар: ", "Атака по замороженным целям наносит +40% комбо-урона (до +90% с талантом).", (255, 215, 80)),
                    ("• Слабости слаймов: ", "Ледяные слаймы получают +60% урона огнём, Огненные — ото льда.", (130, 235, 160))
                ],
                badge_text="КОМБО-УРОН",
                icons=[rock_tower_img, freeze_tower_img]
            )
            draw_guide_card(
                "ФИЗИЧЕСКАЯ БРОНЯ И ЧИСТЫЙ УРОН",
                (80, 210, 255),
                [
                    ("• Броня мобов: ", "Бронированные слаймы снижают физ. урон на 50% (Титаны на 75%).", (255, 180, 180)),
                    ("• Чистый урон: ", "Магия и цепная молния Теслы на 100% игнорируют физическую броню.", (140, 255, 180)),
                    ("• Маг. слаймы: ", "Снижают урон от магии и молнии на 50%–70%. Против них эффективен физ. урон.", (255, 235, 140))
                ],
                badge_text="ТИПЫ УРОНА",
                icons=[magic_tower_img, tesla_tower_img]
            )
            draw_guide_card(
                "ЗАЩИТА БАЗЫ И МЕТЕОРИТЫ",
                (210, 140, 255),
                [
                    ("• Здоровье базы: ", "Базово 10 HP (до 25 HP с талантом «Крепость Базы»).", (240, 245, 255)),
                    ("• Тёмный Эгис: ", "Блокирует 1–2 прорыва врагов за волну без урона базе.", (120, 240, 255)),
                    ("• Фокус метеорита: ", "Клик по упавшему метеориту фокусирует огонь всех башен (+25% радиуса, +10% урона).", (255, 215, 100))
                ],
                badge_text="ОБОРОНА",
            ...
            draw_guide_card(
                "ПАЛАТКА ВОИНОВ И ШИПЫ",
                (80, 225, 120),
                [
                    ("• Солдаты: ", "Спавнит 2–4 воинов со здоровьем 28–268 HP, задерживающих врагов на дороге.", (240, 245, 255)),
                    ("• Точка сбора [R]: ", "Позволяет выставить позицию воинов на любом участке дороги в радиусе палатки.", (160, 230, 255)),
                    ("• Талант «Шипы»: ", "Отражает атакующим мобам +30%/ур. урона (до 150% возврата урона на 5 ур.).", (255, 140, 100))
                ],
                badge_text="ГАРНИЗОН",
                icons=[tent_tower_img, soldier_img]
            )
            draw_guide_card(
                "КАКТУСОВАЯ ФЕРМА И ПОЛИВ",
                (255, 215, 60),
                [
                    ("• Доход: ", "Приносит от 35 до 700+ кактусов в конце волны (+10%/ур. «Плодородной Почвы»).", (240, 245, 255)),
                    ("• Аура Орошения: ", "Поливает соседние башни каждые 14–24 сек., ускоряя их атаку на +8%, +14% или +20%.", (130, 240, 160)),
                    ("• Размещение: ", "Ставьте ферму в окружении боевых башен для максимального эффекта ауры.", (100, 235, 255))
                ],
                badge_text="ДОХОД И ТЕМП",
                icons=[farm_tower_img, cactus_img]
            )
            draw_guide_card(
                ...
                (90, 235, 255),
                [
                    ("• Цепной разряд: ", "Поражает 3 цели базово (до 6+ целей на высоких уровнях).", (240, 245, 255)),
                    ("• Чистый урон: ", "Молния игнорирует физическую броню слаймов на 100%.", (140, 255, 180)),
                    ("• Реликвия «Громовой Зуб»: ", "Добавляет +3 дополнительных перескока цепи молнии.", (255, 215, 80))
                ],
            ...
            draw_guide_card(
                "СКЕЙЛИНГ ЦЕНЫ ДУБЛИКАТОВ",
                (255, 215, 60),
                [
                    ("• Множители покупки: ", "Каждая следующая башня того же типа дороже: ×1.2, ×1.2, ×1.5, ×1.5, ×2, ×3, ×4.", (255, 215, 80)),
                    ("• После 7-й башни: ", "Цена покупки умножается на ×4.0 за каждую последующую копию.", (255, 140, 120)),
                    ("• Совет: ", "Комбинируйте разные типы башен, чтобы избежать резкого удорожания дубликатов.", (140, 245, 170))
                ],
                badge_text="ПРОГРЕССИЯ",
                icons=[cactus_img, crown_upg_icon]
            )
            draw_guide_card(
                "МОДИФИКАТОР КАРТ И ПРОДАЖА",
                (100, 220, 255),
                [
                    ("• Коэффициент биома: ", "Базовые цены башен масштабируются от ×1.05 на Карте 0 до ×1.10 на Карте 9.", (240, 245, 255)),
                    ("• Продажа башни: ", "Возвращает 70% всех вложенных средств (покупка + все уровни прокачки).", (140, 255, 180)),
                    ("• Скидка: ", "Реликвия «Шахтёрский Жетон» снижает цену первой башни каждого типа на -10%/ур.", (255, 220, 120))
                ],
            ...
            draw_guide_card(
                ...
                (255, 120, 150),
                [
                    ("• Скорость игры: ", "[Пробел] переключает скорость: 0.2X, 1X, 2X, 3X, 5X.", (255, 215, 90)),
                    ("• Орбитальный Залп: ", "Клавиша [F] стягивает врагов в воронку и уничтожает метеорит.", (255, 150, 210)),
                    ("• Быстрая прокачка [МАКС]: ", "Улучшает выбранную башню сразу на все доступные деньги в 1 клик.", (255, 180, 200))
                ],
