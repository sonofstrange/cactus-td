...
def draw_greenhouse_screen(surface, savedata, mouse_pos, inspected_cactus_id=None, bg_time=None):
    ...
    return back_btn, upgrade_buttons, card_rects, modal_close_btn, modal_upg_btn
...
def draw_upgrade_tree_screen(surface, savedata, mouse_pos, cam_x, cam_y, selected_node_id, is_dragging=False, zoom=1.0, bg_time=None):
    ...
    hdr_center_x = (dark_bal_rect.right + center_btn_rect.left) // 2
    ...
    return back_btn_rect, center_btn_rect, buy_btn_rect, toggle_btn_rect, node_screen_rects, dark_bal_rect, zoom_in_rect, zoom_out_rect, zoom_reset_rect
...
def draw_mechanics_guide_modal(surface, mouse_pos, current_tab=0):
    ...
    if current_tab == 0:
        ...
        draw_guide_card(
            ...
            (255, 140, 40),
            [
                ("• Заморозка: ", "Ледяная башня замедляет врагов до -80% (базово 36% + уровень) на 2.4-4.2 сек.", (240, 245, 255)),
                ("• Синергия: ", "Башня Камней наносит +40% комбо-урона (до +90% с талантом) по заморозке!", (255, 215, 80)),
                ("• Уязвимость: ", "Ледяное желе получает +60% урона от огня, но на 70% устойчиво к холоду.", (130, 235, 160))
            ],
        ...
        draw_guide_card(
            ...
            (80, 210, 255),
            [
                ("• Броня мобов: ", "Серые и тяжелые слаймы снижают физический урон на 50% (в Петле — на 75%).", (255, 180, 180)),
                ("• Чистый урон: ", "Стрелы Магии и молнии Теслы на 100% игнорируют физическую броню врагов!", (140, 255, 180)),
                ("• Сопротивление: ", "Магические слаймы гасят магию/молнию, а Теневые режут любой урон на 50%.", (255, 235, 140))
            ],
        ...
        draw_guide_card(
            ...
            (210, 140, 255),
            [
                ("• Жизни базы: ", "Базово 12 сердец (+1 сердце за каждые 20 волн с талантом «Оплот Жизни»).", (240, 245, 255)),
                ("• Тёмный Эгис: ", "Космический щит блокирует до 2 прорывов врагов за волну без потери жизней!", (120, 240, 255)),
                ("• Метеорит: ", "Падает каждые 15-20 волн. Клик по нему фокусирует огонь башен (+25% радиуса).", (255, 215, 100))
            ],
        ...
        draw_guide_card(
            ...
            (80, 225, 120),
            [
                ("• Гарнизон: ", "2 воина (ур. 0-3), 3 воина (ур. 4-7), 4 воина (ур. 8+). Здоровье: 28-268 HP.", (240, 245, 255)),
                ("• Точка сбора [R]: ", "Устанавливает позицию солдат на любом участке дороги в зоне действия палатки.", (160, 230, 255)),
                ("• Талант «Шипы»: ", "Возвращает атакующему врагу +30%/ур. урона (до 150% урона на 5 ур. таланта)!", (255, 140, 100))
            ],
        ...
        draw_guide_card(
            ...
            (255, 215, 60),
            [
                ("• Доход: ", "Приносит от 35 до 700+ кактусов в конце каждой волны (растёт с уровнем и талантами).", (240, 245, 255)),
        ...
        draw_guide_card(
            ...
            [
                ...
                ("• Пробитие брони: ", "Электрический разряд на 100% игнорирует физическую броню слаймов.", (140, 255, 180)),
        ...
        draw_guide_card(
            ...
            (255, 205, 80),
            [
                ("• Звёздные кактусы: ", "Дроп со слаймов (8%), боссов (25%), раскопок и рубежей волн (10, 25, 50, 75).", (255, 235, 140)),
                ("• Тёмные кактусы: ", "Выпадают из упавших Метеоритов и боссов 2000+. Нужны для технологий Бездны.", (220, 140, 255)),
                ("• Быстрый старт: ", "Рубежи открывают старт забега сразу с 6, 11, 26 или 101 волны в меню карт!", (140, 245, 170))
            ],
            badge_text="ВАЛЮТЫ И РУБЕЖИ",
        ...
        draw_guide_card(
            ...
            (195, 120, 255),
            [
                ("• Раскопки [R]: ", "Курганы на картах запускают мини-игру 5х5 (7 попыток найти реликвию биома).", (160, 220, 255)),
                ("• Пьедесталы (100%): ", "До 5 активных слотов в Музее для получения полной силы бонусов реликвий.", (255, 220, 130)),
                ("• Тёмный Резонанс: ", "Даёт +5%/ур. (до +20% на 4 ур.) силы ВСЕМ неэкипированным реликвиям пассивно!", (225, 160, 255))
            ],
...
def draw_relics_screen(surface, savedata, mouse_pos, bg_time=None):
    ...
    return back_btn, relic_click_rects, pedestal_click_rects
...
def draw_main_menu_screen(surface, mouse_pos, demo_sim, bg_time=None):
    ...
    surface.blit(foot_txt, (cx - foot_txt.get_width() // 2, SCREEN_HEIGHT - 34))
