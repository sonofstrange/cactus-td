    ...
    if context == "tree":
        if current_tab == 0:
            ...
            draw_guide_card(
                ...
                (80, 210, 255),
                [
                    ("• Новые башни: ", "Разблокирует Ледяную башню, Палатку воинов, Теслу и Ферму (плюс орошение).", (240, 245, 255)),
                    ("• Лимит уровней (+15): ", "Увеличивает максимальный потолок прокачки башен в бою суммарно до +15 уровней!", (140, 255, 180)),
            ...
            draw_guide_card(
                ...
                (255, 205, 80),
                [
                    ("• Источники: ", "Выпадают со слаймов, гарантированно с боссов (каждые 25 волн) и в раскопках.", (240, 245, 255)),
        ...
        if current_tab == 0:
            ...
            draw_guide_card(
                ...
                [
                    ...
                    ("• Боссы каждые 25 волн: ", "Победа над каждым боссом приносит наибольшее количество ростков.", (255, 215, 90))
                ],
