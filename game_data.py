...
from config import (
    ...
    freeze_tower_img, tent_tower_img, dark_cactus_img, stellar_cactus_img_s,
...
UPGRADE_TREE_NODES = {
    ...
    "orbital_strike": {
        ...
        "desc": [
            ...
            "Наносит огромный урон по площади с ручным прицелом!",
    ...
    "dark_transcendence": {
        ...
        "stat_cur": lambda lvl: f"+{lvl} к макс. уровню всех башен (до 35 ур.)" if lvl > 0 else "Кап башен не расширен",
...
def get_tower_build_cost(tower_type, towers, savedata=None, game_map=0, session_towers_bought=0):
    base_costs = {"magic": 100, "rock": 200, "freeze": 150, "tent": 220, "tesla": 250, "farm": 120}
