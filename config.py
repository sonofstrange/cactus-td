...
tree_target_icon = load_texture("tree_target_icon.png", target_size=(46, 46))
tree_frost_icon = load_texture("tree_frost_icon.png", target_size=(46, 46))
tree_rally_icon = load_texture("tree_rally_icon.png", target_size=(46, 46))
tree_solar_trail_icon = load_texture("tree_solar_trail_icon.png", target_size=(46, 46))
tree_prism_icon = load_texture("tree_prism_icon.png", target_size=(46, 46))
tree_beam_limit_icon = load_texture("tree_beam_limit_icon.png", target_size=(46, 46))
tree_bestiary_dmg_icon = load_texture("tree_bestiary_dmg_icon.png", target_size=(46, 46))
tree_bestiary_cacti_icon = load_texture("tree_bestiary_cacti_icon.png", target_size=(46, 46))
tree_bestiary_stars_icon = load_texture("tree_bestiary_stars_icon.png", target_size=(46, 46))
tree_dark_heart_icon = load_texture("tree_dark_heart_icon.png", target_size=(46, 46))
tree_astral_beacon_icon = load_texture("tree_astral_beacon_icon.png", target_size=(46, 46))
tree_event_horizon_icon = load_texture("tree_event_horizon_icon.png", target_size=(46, 46))
tree_gravity_well_icon = load_texture("tree_gravity_well_icon.png", target_size=(46, 46))
